...
import os
import shutil
import uuid #package for unique IDs
...
def build_and_run(code, lang):
    ...
    #add date, time and test if interested to expand the project
    ...
    try:
        client.containers.run(
            ...
            volumes = {source_file_host_dir: {'bind': source_file_guest_dir, 'node': 'rw'}},
